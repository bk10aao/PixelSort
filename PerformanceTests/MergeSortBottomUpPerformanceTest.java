...
public class MergeSortBottomUpPerformanceTest {
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("MergeSortBottomUp_performance_data.csv")) {
    ...
    private static long benchmarkSort(int[] array) {
        ...
        MergeSortBottomUp.sort(arrayCopy);
